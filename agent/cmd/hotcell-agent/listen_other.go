...
// socket via HOTCELL_AGENT_LISTEN instead.
func listenDefault() (net.Listener, error) {
	return nil, errors.New("vsock transport is only available on the Linux guest; set HOTCELL_AGENT_LISTEN=tcp://… or unix://… for local dev")
}
